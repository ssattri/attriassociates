...
const groups = [
  ...
  ["Content & commerce", [["▱", "Projects", "/admin/projects"], ["▤", "Articles", "/admin/articles"], ["◈", "Products", "/admin/products"], ["▣", "Orders", "/admin/orders"], ["☆", "Reviews", "/admin/reviews"], ["▧", "Website content", "/admin/content"]]],
